...
function normalizeTransaction(t) {
  ...
  const keyMap = {
    ...
    itemName: ['itemname', 'item_name', 'itemName', 'สินค้าคงคลัง', 'สินค้า', 'ชนิดวัตถุดิบ', 'ชื่อสินค้า', 'รายการสินค้า', 'ชื่อวัตถุดิบ', 'วัตถุดิบ', 'วัตถุดิบ/สินค้า', 'ชื่อสินค้า/วัตถิบ', 'สินค้า/วัตถิบ', 'สินค้าคงคลัง/วัตถุดิบ', 'คอลัมน์ 1', 'คอลัมน์1', 'column 1', 'column1'],
    quantity: ['quantity', 'จำนวน', 'ปริมาณ', 'qty', 'คอลัมน์ 2', 'คอลัมน์2', 'column 2', 'column2'],
    unit: ['unit', 'หน่วย', 'หน่วยนับ', 'คอลัมน์ 3', 'คอลัมน์3', 'column 3', 'column3'],
    pricePerUnit: ['priceperunit', 'price_per_unit', 'pricePerUnit', 'ราคาต่อหน่วย', 'ราคาทุนต่อหน่วย', 'ราคาทุนล่าสุด', 'ราคา/หน่วย', 'ทุน/หน่วย', 'ทุนต่อหน่วย', 'คอลัมน์ 4', 'คอลัมน์4', 'column 4', 'column4']
  };
